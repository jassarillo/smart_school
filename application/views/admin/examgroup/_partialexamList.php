            ...
            if ($this->rbac->hasPrivilege('exam_assign_view_student', 'can_view')) {
                ...
                <button type="button" data-toggle="tooltip"
                    ...
                    if ($this->rbac->hasPrivilege('exam_subject', 'can_view')) {
                        ?>
                <button class="btn btn-default btn-xs" id="subjectModalButton" data-toggle="tooltip"   data-exam_id="<?php echo $exam_value->id; ?>"  title="<?php echo $this->lang->line('subjects') ?>"><i class="fa fa-book" aria-hidden="true"></i></button>
                <?php
            }

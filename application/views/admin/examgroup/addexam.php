            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"> <?php echo $this->lang->line('list'). " evaluación"; ?></h3>
                    ...
                    <div class="box-body">
                        ...
                        <div class="row pb10">
                            <div class="col-lg-2 col-md-3 col-sm-12 col-xs-6">
                                <p class="examinfo"><span> Nombre</span> <?php echo $examgroup->name; ?></p>
                            </div><!--./col-lg-4-->
                            <div class="col-lg-2 col-md-3 col-sm-12 col-xs-6">
                                <p class="examinfo"><span> <?php echo  $this->lang->line('type'). " evaluación" ?></span> <?php echo $examType[$examgroup->exam_type]; ?></p>
                            </div><!--./col-lg-4-->
                            ...
                            <table class="table table-hover table-striped table-bordered loading1" id="exam_table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text text-center"><?php echo $this->lang->line('result'); ?></th>
